...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি আরাফাত প্রেম করার জন্য😜 মেয়ে খুঁজে দাও 🤭👈!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
https://www.facebook.com/profile.php?id=100092252689283

🔵WHATSAPP NUMBER: wa.me/+8801894153952

🟢SUPPORT EMAIL: arafat.bot.33@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
