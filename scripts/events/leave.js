...
module.exports.run = async function({ api, event, Users, Threads }) {
	...
	const type = (event.author == event.logMessageData.leftParticipantFbId) ? "তোর এতো বড় সাহস আমি আরাফাত বট থাকতে লিভ নিবি দাঁড়া তোরে আবার এড দিবো 🤢🤨" : "Kicked by Administrator";
